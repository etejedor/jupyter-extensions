...
import { swanProjectIcon } from './components/icons';
...
export const ProjectForm: React.FunctionComponent<{
  ...
  const stackOptionsControls = (
    <>
      <Alert severity="info">
        Notebooks in this project will always use the fixed software stack
  ...
  const form = (
    <>
      ...
      {stackType != 'default' ? (
        ...
        <Alert severity="info">
          This project will use the software stack selected when starting the
          SWAN session.
        </Alert>
      )}
    </>
    ...
    <div className="sw-Dialog-content">
      ...
      <div className="sw-Dialog-button-area">
        ...
        <Button
          ...
          disabled={props.isLoading}
        >
          {project?.full_path ? 'Edit Project' : 'Create Project'}
        </Button>
      </div>
    </div>
  );
