...
import { showErrorMessage, Spinner } from '@jupyterlab/apputils';
import { VDomRenderer } from '@jupyterlab/apputils';
import { classes, LabIcon } from '@jupyterlab/ui-components';
import { ILauncher, LauncherModel } from '@jupyterlab/launcher';

import { swanProjectsIcon } from './components/icons';
...
export class SWANLauncher extends VDomRenderer<LauncherModel> {
  ...
  private isProjectAllowedInPath: boolean = false;
  ...
  constructor(
    ...
    private projectsPlugin: SwanProjectsPlugin
  ) {
    super(options.model);
  ...
  /**
   * The current working directory of the launcher.
   */
  get cwd(): string {
    return this._cwd;
  }
  ...
  protected render(): React.ReactElement<any> | null {
    ...
    KNOWN_CATEGORIES = ['Notebook', 'Console', 'Project', 'Other'];
